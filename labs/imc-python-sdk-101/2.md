# Introduction to IMC Python SDK - Cisco DevNet Learning Labs
...
Connect to an IMC, query for various IMC object Classes and manipulate the output. Then disconnect from the IMC.
  ...
  ![](/posts/files/imc-python-sdk-101/assets/images/imc-python-sdk-101-11.jpg)</br></br>
  ...
  ![](/posts/files/imc-python-sdk-101/assets/images/imc-python-sdk-101-12.jpg)</br></br>
  ...
  ![](/posts/files/imc-python-sdk-101/assets/images/imc-python-sdk-101-13.jpg)</br></br>

  <!---![](assets/images/imc-python-sdk-101-13.jpg)</br></br>--->

  Because query_classid returns a list, the list can be looped through without having to know the length of the list. Even if there is only one object returned from a `query_classid` like the ComputeRackUnit object, the object will be in a single entry list.
  ...
  ![](/posts/files/imc-python-sdk-101/assets/images/imc-python-sdk-101-16.jpg)</br></br>
...
IMC Python SDK has built in help as we saw earlier in the lab, it also has built in MetaData. The built in MetaData allows you to find where objects fit in the IMC Object Model and what attributes and potential values an object can have.
  ...
  ![](/posts/files/imc-python-sdk-101/assets/images/imc-python-sdk-101-14.jpg)</br></br>

  <!---![](assets/images/imc-python-sdk-101-14.jpg)</br></br>--->

  There are a number of things shown here, first is the containment of the object, in this case `CommHttps` objects are contained under `CommSvcEp`. Also every attribute and all the MetaData for the attributes is displayed. For example the `admin_state` attribute's value_set is displayed which enables the programmatic ability to do validation of input that is meant for `admin_state`
  ...
  ![](/posts/files/imc-python-sdk-101/assets/images/imc-python-sdk-101-15.jpg)</br></br>
